    ...
    return (
        <Fragment>
            ...
            <main className="flex gap-4">
                <Sidebar />
                <div>
                    <div className="flex flex-col w-[300px] mt-2 relative">
                        ...
                        <textarea value={text} onChange={onTextChange} className="border border-neutral-400 rounded-b-md focus:outline-none border-t-0 p-1 resize-none w-full h-24" placeholder="Enter Text" />
                    ...
                    <div>{
                        pinnedNotes?.length > 0 && (
                            <div className="mt-14 flex flex-wrap gap-4 items-start">
